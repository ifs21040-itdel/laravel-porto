            ...
            <div class="container">
                <div class="row">
                                ...
                                <div class="owl-carousel owl-theme text-center">
                                    <div class="item">
                                        <div class="gallery-item-inner">
                                            <a href="images/portfolio/2.jpg" title="" class="img-zoom">
                                                <div class="gallery-box">
                                                    <div class="gallery-img"> <img src="images/portfolio/2.jpg" class="img-fluid mx-auto d-block" alt=""> </div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4 offset-md-1">
                        <h6 class="wow" data-splitting>Object-oriented Programming</h6>
                        <h1 class="wow" data-splitting>Calculator Scientific</h1>
                        <p class="mt-45 wow fadeInUp" data-wow-delay=".1s">A scientific calculator is a calculator that provides complex and special mathematical functions. In this project, I created it using the Java language and tools available in NetBeans which help in adding functions to the calculator application that has been created. For the GUI display, it was created directly in NetBeans and uses existing tools</p>
                        <p class="mt-45 wow fadeInUp" data-wow-delay=".2s"><span>Date :</span> 20 Oktober 2022</p>
                        <p class="wow fadeInUp" data-wow-delay=".3s"><span>Category :</span> Java-Netbeens </p>
