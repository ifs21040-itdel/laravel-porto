        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="owl-carousel owl-theme text-center">
                                <div class="item">
                                    <div class="gallery-item-inner">
                                        <a href="images/portfolio/3.jpg" title="" class="img-zoom">
                                            <div class="gallery-box">
                                                <div class="gallery-img"> <img src="images/portfolio/3.jpg" class="img-fluid mx-auto d-block" alt=""> </div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-md-4 offset-md-1">
                    ...
                    <h1 class="wow" data-splitting>Financial Records</h1>
                    ...
                    <p class="mt-45 wow fadeInUp" data-wow-delay=".2s"><span>Date :</span> 10 December 2022</p>
                    <p class="wow fadeInUp" data-wow-delay=".3s"><span>Category :</span> Java-NetBeans and SQLyog </p>
