        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="owl-carousel owl-theme text-center">
                                <div class="item">
                                    <div class="gallery-item-inner">
                                        <a href="images/portfolio/4.jpg" title="" class="img-zoom">
                                            <div class="gallery-box">
                                                <div class="gallery-img"> <img src="images/portfolio/4.jpg" class="img-fluid mx-auto d-block" alt=""> </div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-md-4 offset-md-1">
                    ...
                    <h1 class="wow" data-splitting>Del Institute of Technology Homepage Redesign</h1>
                    ...
                    <p class="mt-45 wow fadeInUp" data-wow-delay=".2s"><span>Date :</span> 12 Mei 2023</p>
                    ...
                    <div class="btn-wrap wow fadeInUp text-left mt-45" data-wow-delay=".9s">
                        <div class="btn-link"> <a href="https://www.figma.com/file/vrrARkrquJ5bRTDxPAqT45/Homepage-Website-IT-Del?type=design&node-id=66%3A2&mode=design&t=tZVity8KYGnFScoc-1">Live website <i class="ti-arrow-top-right"></i> </a> <span class="btn-block color1 animation-bounce"></span> </div>
                    </div>
                </div>
            </div>
        </div>
