      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 offset-md-1">
            <h6 class="wow" data-splitting>Computer Networks</h6>
            <h1 class="wow" data-splitting>Chatting Application</h1>
            <p class="mt-45 wow fadeInUp" data-wow-delay=".1s">
              A chat application is an application that allows users to communicate directly with each other via text, images, sound, or other media.
              In this computer networks course project I use Python. Python has a syntax that is easy to read and understand, making it suitable for application development with diverse teams. 
              Its combination of ease of use, rich library ecosystem, and flexibility makes Python a popular choice for chat application development.
            </p>
            <p class="mt-45 wow fadeInUp" data-wow-delay=".2s">
              <span>Date :</span> 10 June 2023
            </p>
            <p class="wow fadeInUp" data-wow-delay=".3s">
              <span>Category :</span> Python-VisualStudioCode
            </p>
            <div
            ...
            >
              <div class="btn-link">
                <a href="https://youtu.be/_lGfIjvmGnk">Live website <i class="ti-arrow-top-right"></i> </a>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 mb-30">
              ...
              >
                <div class="btn-link">
                  <a href="#">agnesmarbun2311@gmail.com</a>
