        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="owl-carousel owl-theme text-center">
                                <div class="item">
                                    <div class="gallery-item-inner">
                                        <a href="images/portfolio/6.jpg" title="" class="img-zoom">
                                            <div class="gallery-box">
                                                <div class="gallery-img"> <img src="images/portfolio/6.jpg" class="img-fluid mx-auto d-block" alt=""> </div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="col-md-4 offset-md-1">
                    <h6 class="wow" data-splitting>Artificial Inteligent</h6>
                    <h1 class="wow" data-splitting>Sudoku Solver using Heuristics Search Backtracking</h1>
                    <p class="mt-45 wow fadeInUp" data-wow-delay=".1s">The most suitable heuristic to use in increasing the efficiency of sudoku code is the singleton heuristic. Because this method is the simplest and can provide good results with relative overhead.</p>
                    <p class="mt-45 wow fadeInUp" data-wow-delay=".2s"><span>Date :</span> 20 Oct 2023</p>
                    <p class="wow fadeInUp" data-wow-delay=".3s"><span>Category :</span> python</p>
                    <div class="btn-wrap wow fadeInUp text-left mt-45" data-wow-delay=".9s">
                        <div class="btn-link"> <a href="https://youtu.be/5jkW8D4sREM?si=ZxpzdU23sZODGAfx">Live website <i class="ti-arrow-top-right"></i> </a> <span class="btn-block color1 animation-bounce"></span> </div>
                    </div>
                </div>
            </div>
        </div>
